            ...
            foreach ($arguments as $property => $argument) {
                ...
                if (method_exists( $object, $local_function )) {
                    if (is_string( $argument )) {   //Check if get function or $argument are DateTime Type
                        if (trim( $argument ) === '' && $object->$get_local_function() === null) {
                            continue; // En este caso como el argumento que se pasa es vacio y lo que tiene tambien esta vacio...
                        }
